...
class V2ValidatorServiceIntegrationSpec
    extends AnyFreeSpec
    with Matchers
    with ScalaFutures
  ...
  val jsonValidationService = new V2JsonValidationServiceImpl()
  val xmlValidationService  = new V2XmlValidationServiceImpl()
