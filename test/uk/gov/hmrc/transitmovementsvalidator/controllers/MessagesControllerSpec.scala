...
import uk.gov.hmrc.transitmovementsvalidator.models.errors.{SchemaValidationError, ValidationError}
...
class MessagesControllerSpec extends AnyFreeSpec with Matchers with MockitoSugar with StubControllerComponentsFactory with TestActorSystem with BeforeAndAfterEach with NonEmptyListFormat {
