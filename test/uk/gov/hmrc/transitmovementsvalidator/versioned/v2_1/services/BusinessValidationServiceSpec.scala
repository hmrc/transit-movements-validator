...
import uk.gov.hmrc.transitmovementsvalidator.versioned.v2_1.models.MessageFormat
...
class BusinessValidationServiceSpec extends AnyFreeSpec with Matchers with ScalaFutures with ScalaCheckDrivenPropertyChecks with TestActorSystem {
  ...
  lazy val v2TestDataPath = "./test/uk/gov/hmrc/transitmovementsvalidator/versioned/v2_1/data"
