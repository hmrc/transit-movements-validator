...
import uk.gov.hmrc.transitmovementsvalidator.v2_1.models.errors.SchemaValidationPresentationError
...
class ErrorTranslatorSpec extends AnyFreeSpec with Matchers with OptionValues with ScalaFutures with MockitoSugar with ScalaCheckDrivenPropertyChecks {
  ...
  "Validation Error" - {
    ...
    import uk.gov.hmrc.transitmovementsvalidator.v2_1.models.errors.ValidationError._
